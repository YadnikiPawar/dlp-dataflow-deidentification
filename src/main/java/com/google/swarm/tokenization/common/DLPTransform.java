...
public abstract class DLPTransform
     ...
     *
     * Output : PCollection Tuple-
     * Made up of Tuple Tags
     * public static TupleTag<Row> inspectData = new TupleTag<Row>() {
     *     };
     *
     * PCollection<Row> for Inspected data  PCollection<Row> for audit data.
     * **/
    ...
    public static class InspectData extends DoFn<KV<String, String>, Row> {
        ...
        //Set up project id and inspect template
        @Setup
        public void setup() {
            this.requestBuilder =
        ...
        //Set up content and call DLP API
        @ProcessElement
